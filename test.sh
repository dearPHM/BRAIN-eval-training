...
python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=200 --num_users=21 --byzantines=10 --score_byzantines=0 --frac=0.1 --stale=4 --diff=0.55 --window=4 --threshold=0.15 --verbose=0 --local_bs=50
