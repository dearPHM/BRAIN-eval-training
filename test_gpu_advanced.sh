...
# python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=400 --num_users=21 --byzantines=0 --score_byzantines=5 --frac=0.1 --stale=4 --diff=0.55 --window=4 --threshold=0.0 --verbose=0 --local_bs=50 --gpu=0
python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=400 --num_users=21 --byzantines=0 --score_byzantines=10 --frac=0.1 --stale=4 --diff=0.55 --window=4 --threshold=0.0 --verbose=0 --local_bs=50 --gpu=0
python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=400 --num_users=21 --byzantines=0 --score_byzantines=11 --frac=0.1 --stale=4 --diff=0.55 --window=4 --threshold=0.0 --verbose=0 --local_bs=50 --gpu=0
python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=400 --num_users=21 --byzantines=0 --score_byzantines=15 --frac=0.1 --stale=4 --diff=0.55 --window=4 --threshold=0.0 --verbose=0 --local_bs=50 --gpu=0
...
# python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=400 --num_users=21 --byzantines=0 --score_byzantines=10 --frac=0.1 --stale=4 --diff=0.25 --window=4 --threshold=0.0 --verbose=0 --local_bs=50 --gpu=0
# python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=400 --num_users=21 --byzantines=0 --score_byzantines=10 --frac=0.1 --stale=4 --diff=0.55 --window=4 --threshold=0.0 --verbose=0 --local_bs=50 --gpu=0
# python src/brain_main.py --model=cnn --dataset=cifar --iid=1 --epochs=400 --num_users=21 --byzantines=0 --score_byzantines=10 --frac=0.1 --stale=4 --diff=0.75 --window=4 --threshold=0.0 --verbose=0 --local_bs=50 --gpu=0
